...
u=setTimeout(S,t),g(f))}return void 0===u&&(u=setTimeout(S,t)),l}return t=T(t)||0,y(r)&&(s=!!r.leading,i=(m="maxWait"in r)?v(T(r.maxWait)||0,t):i,d="trailing"in r?!!r.trailing:d),O.cancel=function(){void 0!==u&&clearTimeout(u),c=0,o=f=a=u=void 0},O.flush=function(){return void 0===u?l:j(b())},O}(e,t,{leading:o,maxWait:t,trailing:a})};const h=document.querySelector(".feedback-form input"),S=document.querySelector(".feedback-form textarea"),j=document.querySelector(".feedback-form");let O={email:"",message:""};!0==(void 0!=(e=r.load("feedback-form-state"))&&(O=e,!0))&&(h.value=O.email,S.value=O.message),h.addEventListener("input",o(e=>{null!=e.currentTarget&&(O.email=e.currentTarget.value,r.save("feedback-form-state",O),console.log(O.email))},500)),S.addEventListener("input",o(e=>{null!=e.currentTarget&&(O.message=e.currentTarget.value,r.save("feedback-form-state",O),console.log(O.message))},500)),j.addEventListener("submit",e=>{e.preventDefault();let t=e.currentTarget;O.email=t.elements.email.value,O.message=t.elements.message.value,r.remove("feedback-form-state"),t.reset(),console.log("feedback-form-state = ",O)}),console.log(O);//# sourceMappingURL=03-feedback.ce9d2a6c.js.map

//# sourceMappingURL=03-feedback.ce9d2a6c.js.map
