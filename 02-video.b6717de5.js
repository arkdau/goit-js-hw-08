 ...
 */var G={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},U=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&m(e,t)}(a,e);var t,n,r,o,i=(t=g(),function(){var e,n=y(a);if(t){var r=y(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return k(e)}(this,e)});/**
...
r.element=i,r._originalElement=e,n=e,o=F.get(n),F.set(i,o),F.delete(n),$.set(r.element,r),t)}).catch(n)}});if(// Store a copy of this Player in the map
H.set(this,a),$.set(this.element,this),"IFRAME"===this.element.nodeName&&q(this,"ping"),Y.isEnabled){var u=function(){return Y.exit()};this.fullscreenchangeHandler=function(){Y.isFullscreen?L(r,"event:exitFullscreen",u):R(r,"event:exitFullscreen",u),// eslint-disable-next-line
r.ready().then(function(){q(r,"fullscreenchange",Y.isFullscreen)})},Y.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
...
return!!document[r.fullscreenEnabled]}}}),Y=i,/**
 ...
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
if(!window.VimeoCheckedUrlTimeParam){window.VimeoCheckedUrlTimeParam=!0;var t=function(e){"console"in window&&console.error&&console.error("There was an error getting video Id: ".concat(e))};window.addEventListener("message",function(n){if(P(n.origin)){var r=I(n.data);if(r&&"ready"===r.event)for(var o=e.querySelectorAll("iframe"),i=0;i<o.length;i++)!function(){var e=o[i],r=e.contentWindow===n.source;if(j(e.src)&&r){var a=new Q(e);a.getVideoId().then(function(e){var t=new RegExp("[?&]vimeo_t_".concat(e,"=([^&#]*)")).exec(window.location.href);if(t&&t[1]){var n=decodeURI(t[1]);a.setCurrentTime(n)}}).catch(t)}}()}})}}());var B={save:(e,t)=>{try{let n=JSON.stringify(t);localStorage.setItem(e,n)}catch(e){console.error("Set state error: ",e.message)}},load:e=>{try{let t=localStorage.getItem(e);return null===t?void 0:JSON.parse(t)}catch(e){console.error("Get state error: ",e.message)}},remove:e=>{try{localStorage.removeItem(e)}catch(e){console.error("Get state error: ",e.message)}}},J={},X="Expected a function",K=0/0,Z=/^\s+|\s+$/g,ee=/^[-+]0x[0-9a-f]+$/i,et=/^0b[01]+$/i,en=/^0o[0-7]+$/i,er=parseInt,eo="object"==typeof a&&a&&a.Object===Object&&a,ei="object"==typeof self&&self&&self.Object===Object&&self,ea=eo||ei||Function("return this")(),eu=Object.prototype.toString,ec=Math.max,el=Math.min,es=function(){return ea.Date.now()};/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.querySelector("iframe"),ep=new Q(eh);ep.on("play",function(){console.log("played the video!")}),ep.getVideoTitle().then(function(e){console.log("title:",e)}),ep.on("play",e=>{//console.log('Player start: ', data);
let t=0;console.log(`videoplayer-current-time: ${t=B.load("videoplayer-current-time")} sec`),ep.setCurrentTime(t).then(function(e){}).catch(function(e){e.name})}),ep.on("timeupdate",J(e=>{console.log("time update: ",e),B.save("videoplayer-current-time",e.seconds)},1e3)),console.log("localStorage: ",B);//# sourceMappingURL=02-video.b6717de5.js.map

//# sourceMappingURL=02-video.b6717de5.js.map
